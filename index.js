...
//         filePath,
//         content,
//         path.join(fieldName, `${oldConfig[key] ? oldConfig[key] : value}.js`) // Đường dẫn cũ cho file js
//       );
//     }
//   }
// }
...
//       .filter((value, index) => {
//         const key = Object.keys(config)[index];
//         return key !== "folderName" && key !== "fieldName";
//       })
//       .map((value) => `${value}.js`);
...
//     // Kiểm tra và tạo mới folderName, fieldName nếu không có trong oldConfig
//     if (!oldConfig.folderName || oldConfig.folderName !== config.folderName) {
//       await createFolder(baseFolder);
//     }
//     if (!oldConfig.fieldName || oldConfig.fieldName !== config.fieldName) {
//       await createFolder(fieldName);
//     }
